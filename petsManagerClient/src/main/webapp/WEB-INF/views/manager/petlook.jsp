            ...
            <div class="gallery-one two">
                <div class="col-md-3 gallery-left two">
                    <c:forEach items="${petsList}" var="pets">
                        <a href="/pet/${pets.id}" class=" mask b-link-stripe b-animate-go   swipebox"  title="Image Title">
                            <img src="http://pmupn7ccj.bkt.clouddn.com/${pets.image}-preview" alt="" class="img-responsive zoom-img"/>
                        </a>
                    </c:forEach>
                </div>
            </div>
