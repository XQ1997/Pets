...
<head>
    ...
    <title>流浪宠物救助系统 | 流浪宠物管理 | 编辑流浪宠物</title>
                        ...
                        <div class="row">
                            <div class="col-md-8">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="petname" class="form-control" value="${pets.petname}" autofocus/>
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <input type="text" name="place" class="form-control" value="${pets.place}"/>
                                    </div>
                                </div>
                                <div class="form-group">
